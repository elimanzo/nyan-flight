...
export const PauseOverlay = () => {
  ...
  return (
    <AnimatePresence>
      {open && (
        <motion.div
          className="pointer-events-none absolute inset-0 z-20 flex flex-col items-center justify-center bg-black/60"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
        >
          <div className="pointer-events-auto rounded-3xl border border-white/10 bg-[#090221]/80 px-8 py-10 text-center text-white">
